 ...
 *
 */
public class Auton1FromSourceRed extends SequentialCommandGroup {


    public Auton1FromSourceRed() {
        ...
        addCommands(new cmdTurnByGyro(45,0.2,true));
        addCommands(new cmdResetGyro());
        ...
        //returning
        addCommands(new cmdResetGyro());
        addCommands(new cmdTurnByGyro(-24, 0.2, false));
        addCommands(new cmdResetGyro());
