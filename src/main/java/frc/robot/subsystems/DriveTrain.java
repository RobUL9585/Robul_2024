...
intakeSpin = new CANSparkMax(7, MotorType.kBrushless);
intakeSpin.setInverted(false);
shooterLower = new CANSparkMax(8, MotorType.kBrushed);
shooterLower.setInverted(true);
shooterHigher = new CANSparkMax(9, MotorType.kBrushed);
shooterHigher.setInverted(true);
    ...
    //     }
    //     else if(driveController.a().getAsBoolean()){
    //         intakeLeft.set(-0.25);
    //         intakeRight.set(-0.25);
    //     }
    //     else{
    ...
    if(armController.x().getAsBoolean()){
        ...
        if(armController.povUp().getAsBoolean()){
            shooterHigher.set(0.7*armController.getRightTriggerAxis());
            shooterLower.set(0.7*armController.getRightTriggerAxis());
        }
        else if(armController.povDown().getAsBoolean()){
            shooterHigher.set(-0.2);
            shooterLower.set(-0.2);
        }
        else if (armController.rightBumper().getAsBoolean()){
            shooterHigher.set(0.20);
            shooterLower.set(0.20);
        }
